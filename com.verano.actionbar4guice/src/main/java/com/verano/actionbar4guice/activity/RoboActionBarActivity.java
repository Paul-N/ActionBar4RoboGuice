...
import com.verano.actionbar4guice.activity.event.*;
import com.verano.actionbar4guice.context.event.OnConfigurationChangedEvent;
import com.verano.actionbar4guice.context.event.OnCreateEvent;
import com.verano.actionbar4guice.context.event.OnDestroyEvent;
import com.verano.actionbar4guice.context.event.OnStartEvent;
 ...
 * {@link roboguice.activity.RoboExpandableListActivity}, {@link roboguice.activity.RoboListActivity}, and other
 ...
 * class ({@link com.verano.actionbar4guice.activity.RoboActivity30}), you won't have to write that much changes. And
...
public class RoboActionBarActivity extends ActionBarActivity implements RoboContext {
    ...
    public View onCreateView(String name, Context context, AttributeSet attrs) {
        if (RoboActivity30.shouldInjectOnCreateView(name))
            return RoboActivity30.injectOnCreateView(name, context, attrs);
